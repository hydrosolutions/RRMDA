...
try
  ...
  if ~exist([current_dir,filesep,'testEnvironment',filesep,'app',filesep,...
         'TestThemi',filesep,'results',filesep,'forecast',filesep,'ET'],'dir') == 7
      mkdir([current_dir,filesep,'testEnvironment',filesep,'app',filesep,...
             'TestThemi',filesep,'results',filesep,'forecast',filesep,'ET']);
  end
  if ~exist([current_dir,filesep,'testEnvironment',filesep,'app',filesep,...
         'TestThemi',filesep,'results',filesep,'forecast',filesep,'Q'],'dir') == 7
    mkdir([current_dir,filesep,'testEnvironment',filesep,'app',filesep,...
           'TestThemi',filesep,'results',filesep,'forecast',filesep,'Q']);
  end
  if ~exist([current_dir,filesep,'testEnvironment',filesep,'app',filesep,...
         'TestThemi',filesep,'results',filesep,'forecast',filesep,'G'],'dir') == 7
    mkdir([current_dir,filesep,'testEnvironment',filesep,'app',filesep,...
          'TestThemi',filesep,'results',filesep,'forecast',filesep,'G']);
  end
  if ~exist([current_dir,filesep,'testEnvironment',filesep,'app',filesep,...
         'TestThemi',filesep,'results',filesep,'forecast',filesep,'S'],'dir') == 7
    mkdir([current_dir,filesep,'testEnvironment',filesep,'app',filesep,...
           'TestThemi',filesep,'results',filesep,'forecast',filesep,'S']);
  end
  if ~exist([current_dir,filesep,'testEnvironment',filesep,'app',filesep,...
