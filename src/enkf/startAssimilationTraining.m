...
dataPath = '~/Dropbox/iMoMoPHASE1/model/iMoMoToolboxTobi/app/themi/resources/trainingData/';
savePath = '~/Dropbox/iMoMoPHASE1/model/iMoMoToolboxTobi/app/themi/resources/samples/'
...
cd(savePath)
load themiSamples
cd('~/Dropbox/iMoMoPHASE1/model/iMoMoToolboxTobi/src/enkf')

paths.home = '~/Dropbox/iMoMoPHASE1/model/iMoMoToolboxTobi/src/enkf/';
paths.dataAssim = '~/Dropbox/iMoMoPHASE1/model/data/processed/biascorrected/';
paths.prm = '~/Dropbox/iMoMoPHASE1/model/iMoMoToolboxTobi/app/themi/prm/';
paths.forecasts = '~/Dropbox/iMoMoPHASE1/model/data/processed/forecast';

[prm, x, x_true, E, stats, EStore] = fmain('../../app/themi/prm/prm-Themi-training.txt',[],E, [], paths);

cd('~/Dropbox/iMoMoPHASE1/model/iMoMoToolboxTobi/app/themi/resources/trainingResults/');
...
cc=hsv(8);
for i = 1 : 8
    qConvFac = 1/(1000*24*3600) * prm.shp(prm.customprm.cID(i)).Area;
