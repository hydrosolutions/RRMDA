% function [x, x_true, E, stats, EStore] = fmain(prmfname, x_true0, E0, stats0)
%
...
function [prm, x, x_true, E, stats, EStore] = fmain(prmfname, x_true0, E0, stats0, paths)

    % read parameters
    prm = get_prm(prmfname,paths);
    
    if nargin == 1
        [prm, x, x_true, E, stats, EStore] = main(prm);
    elseif nargin == 2
        [prm, x, x_true, E, stats, EStore] = main(prm, x_true0);
    elseif nargin == 3
        [prm, x, x_true, E, stats, EStore] = main(prm, x_true0, E0);
    elseif nargin >= 4
        [prm, x, x_true, E, stats, EStore] = main(prm, x_true0, E0, stats0);
    else
